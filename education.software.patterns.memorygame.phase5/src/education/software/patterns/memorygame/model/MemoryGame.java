...
public abstract class MemoryGame {
	...
	private void initializeGame() {
		...
		board = new Board(numbers, getNumberOfRows(), getNumberOfColumns(), howManySpecialPairs());
		score = 0;
	...
	/**
	 * Randomly decide the number of special pairs the game will have
	 * @return an int indicating the number of special pairs (between 0 and 2)
	 */
	private int howManySpecialPairs() {
		Random r = new Random();
		return r.nextInt(3);
	}
